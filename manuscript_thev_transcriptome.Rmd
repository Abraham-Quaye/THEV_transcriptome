...
flextable(sig_12_juncs) %>% theme_zebra() %>%
  set_table_properties(layout = "fixed", width = 1,
                       opts_pdf = list(caption_repeat = F)) %>%
  font(part = "all", fontname = "Avenir") %>%
  set_caption("Table 2a: Most abundant splice junctions at 12h.p.i",
              style = "Table Caption")
```
\newpage
...
flextable(sig_24_juncs) %>% theme_zebra() %>%
  set_table_properties(layout = "fixed", width = 1,
                       opts_pdf = list(caption_repeat = F)) %>%
  font(part = "all", fontname = "Avenir") %>%
  set_caption("Table 2b: Most abundant splice junctions at 24h.p.i",
              style = "Table Caption")
```
\newpage
...
flextable(sig_72_juncs) %>% theme_zebra() %>%
  set_table_properties(layout = "fixed", width = 1,
                       opts_pdf = list(caption_repeat = F)) %>%
  font(part = "all", fontname = "Avenir") %>%
  set_caption("Table 2c: Most abundant splice junctions at 72h.p.i",
              style = "Table Caption")
```
\newpage
