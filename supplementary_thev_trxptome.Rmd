...
flextable(supp_pcr_meth_tab) %>%
  ...
  colformat_image(j = "gel_image", i = c(1:3, 6:16), na_str = "-",
                  width = 1, height = 1) %>%
  ...
  footnote(., i = c(1:4, 6:16), j = 12, value = as_paragraph(c("Primer binds exon 1")),
           ref_symbols = c("a"), part = "body") %>%
  footnote(., i = c(1:4, 6:16), j = 13, value = as_paragraph(c("Primer binds terminal exon")),
